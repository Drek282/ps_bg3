...
if (defined("CLASS_PS_SOURCE_BG3_PHP")) return 1;
define("CLASS_PS_SOURCE_BG3_PHP", 1);

include_once(dirname(__DIR__) . '/source.php');

class PS_source_bg3 extends PS_source {

var $class = 'PS::source::bg3';
var $use_roles = true;
