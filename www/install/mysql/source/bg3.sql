...
INSERT INTO `ps_weapon` (`weaponid`, `uniqueid`, `name`, `skillweight`, `class`) 
    VALUES
        (1, 'old_model_charleville', 'Charleville 1728', 1.00, 'Rifle'),
        (2, 'pattern1776', 'Pattern 1776', 0.90, 'Rifle'),
        (3, 'miquelet', 'Miquelet', 0.90, 'Rifle'),
        (4, 'sea_service', 'Sea Service', 1.00, 'Rifle'),
        (5, 'old_model_charleville_bayonet', 'Charleville 1728 Bayonet', 1.00, 'Melee'),
        (6, 'dutch', 'Dutch', 1.10, 'Rifle'),
        (7, 'longpattern_bayonet', 'Brown Bess Long Pattern Bayonet', 1.00, 'Melee'),
        (8, 'dutch_bayonet', 'Dutch Bayonet', 1.10, 'Melee'),
        (9, 'brownbess_bayonet', 'Brown Bess Bayonet', 1.00, 'Melee'),
        (10, 'brownbess', 'Brown Bess', 0.90, 'Rifle'),
        (11, 'hanger', 'Hanger', 1.10, 'Melee'),
        (12, 'beltaxe', 'Beltaxe', 1.00, 'Melee'),
        (13, 'smallsword', 'Small Sword', 1.10, 'Melee'),
        (14, 'spontoon', 'Spontoon', 1.15, 'Melee'),
        (15, 'pistol_b', 'Hessian Dragoon Pistol', 1.25, 'Pistol'),
        (16, 'sabre', 'Sabre', 0.80, 'Melee'),
        (17, 'club', 'Club', 0.75, 'Melee'),
        (18, 'revolutionnaire_nobayo', 'Revolutionnaire (no bayonet)', 1.00, 'Rifle'),
        (19, 'charleville', 'Charleville 1763', 1.00, 'Rifle'),
        (20, 'charleville_bayonet', 'Charleville 1763 Bayonet', 1.10, 'Melee'),
        (21, 'miquelet_bayonet', 'Miquelet Bayonet', 1.00, 'Melee'),
        (22, 'brownbess_nobayo', 'Brown Bess (no bayonet)', 1.00, 'Rifle'),
        (23, 'tomahawk', 'Tomahawk', 0.85, 'Melee'),
        (24, 'american_brownbess_nobayo', 'American Brown Bess (no bayonet)', 1.00, 'Rifle'),
        (25, 'longpattern_nobayo', 'Brown Bess Long Pattern (no bayonet)', 1.00, 'Rifle'),
        (26, 'longpattern', 'Brown Bess Long Pattern', 1.00, 'Rifle'),
        (27, 'pistol_a', 'Holster Pistol', 1.25, 'Pistol'),
        (28, 'american_brownbess', 'American Brown Bess', 1.00, 'Rifle'),
        (29, 'fowler', 'Fowler', 0.90, 'Shotgun'),
        (30, 'brownbess_carbine', 'Brown Bess Carbine', 1.00, 'Carbine'),
        (31, 'pennsylvania', 'Pennsylvania Longrifle', 1.15, 'Rifle'),
        (32, 'hirschf', 'Hirschfänger', 0.95, 'Melee'),
        (33, 'knife', 'Riflemans Knife', 1.20, 'Melee'),
        (34, 'jaeger', 'Kentucky Longrifle', 1.00, 'Rifle'),
        (35, 'world', 'Swivel Gun', 2.00, 'Artillery'),
        (36, 'brownbess_carbine_nobayo', 'Brown Bess Carbine (no bayonet)', 1.00, 'Carbine'),
        (37, 'revolutionnaire', 'Revolutionnaire', 1.00, 'Rifle'),
        (38, 'swivel_gun', 'Swivel Gun', 2.00, 'Artillery'),
        (39, 'grenade_frag', 'Grenade', 1.25, 'Grenade'),
        (40, 'light_model_charleville', 'Charleville Model 1766', 1.00, 'Rifle'),
        (41, 'light_model_charleville_bayonet', 'Light Model Charleville Bayonet', 1.00, 'melee'),
        (42, 'french_carbine', 'French Carbine', 1.00, 'Carbine'),
        (43, 'rapier', 'Rapier', 1.10, 'Melee'),
        (44, 'oldpattern_bayonet', 'Old Pattern Musket Bayonet', 1.00, 'Melee'),
        (45, 'dagger', 'Dagger', 1.20, 'Melee'),
        (46, 'blunderbuss', 'Blunderbuss', 0.90, 'Shotgun'),
        (47, 'oldpattern', 'Old Pattern Musket', 1.00, 'Rifle'),
        (48, 'artillery_common_carbine_bayonet', 'Artlillery Common Bayonet', 1.00, 'Melee'),
        (49, 'serjeant_fusil', 'Serjeant Fusil', 1.00, 'Rifle');
